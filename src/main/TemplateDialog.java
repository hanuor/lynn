	...
	public TemplateDialog(JFrame frameboy, JPanel parent) {
		...
		sButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (extField.getText().toString().isEmpty()
						|| subField.getText().toString().isEmpty()
						|| temp.getText().toString().isEmpty()) {
					JOptionPane.showOptionDialog(null, "Something is missing",
							"Warning", JOptionPane.DEFAULT_OPTION,
							JOptionPane.WARNING_MESSAGE, null, null, null);
					// JOptionPane.showMessageDialog(getContentPane(),
					// "Hello World");
				} else {
					DatabasePing.saveTemplateMessage(extField.getText()
							.toString(), subField.getText().toString(), temp
							.getText().toString());
					dispose();
				}
				//
